...
SELECT * FROM livros
WHERE valor > 50 AND dt < "2019-06-27" ORDER BY dt ASC;

SELECT * FROM livros 
WHERE valor > 50 OR dt < "2019-06-27" ORDER BY valor DESC;

SELECT * FROM livros WHERE valor > 50 AND dt < "2019-06-27" AND NOT id = 6;
